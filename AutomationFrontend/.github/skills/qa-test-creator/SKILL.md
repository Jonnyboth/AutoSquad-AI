...
Conversión a Skill de `.github/agents/BMO-TestCreator.agent.md` (preservado sin cambios en
...
1. Leer `.github/skills/katalon-mobile-automation/SKILL.md` como fuente de verdad
   ...
   el SKILL.
2. Si la tarea involucra eventos Ads (`rads-tracker`) → cargar skill `qa-rads-tracker` y
   aplicar sus reglas duras de aserción (`RadsTrackerJourneySteps.*`, nunca los legacy
   `RadsTrackerSteps.assert*`).
3. **Puerta de aprobación (obligatoria):** verificar en el contexto de `qa-flow-planner`
...
`Keywords/com/rappi/steps/**`, `Scripts/{android,ios,web}/**`, `Test Cases/{android,ios,web}/**`,
...
**Formato `.rs` (R-K1/R-K2/R-K3):** ver `.github/skills/qa-explorer/references/rs-hard-rules.md`
...
- `.github/skills/qa-explorer/references/rs-hard-rules.md` — R-K1/R-K2/R-K3 (formato `.rs`)
- Fuente original preservada: `.github/agents/BMO-TestCreator.agent.md`
