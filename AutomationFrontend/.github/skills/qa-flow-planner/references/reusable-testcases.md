...
|----------------------|------|------------------------------------|----------------------|
| `openRappi` | `Scripts/android/openRappi/` | Home de Rappi cargado y verificado, anti-crash activo | El flujo comienza desde Home de la app |
...
> convención a seguir cuando se recreen `openRappi`/`OpenStoreGeant` — no asumir que
...
2. ¿El flujo empieza en Home de Rappi?
   → Reutilizar openRappi como setUp. No reescribir la navegación de apertura.
