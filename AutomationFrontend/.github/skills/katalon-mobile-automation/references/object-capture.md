...
<hierarchy rotation="0">
  <node index="0" text="" resource-id="" class="android.widget.FrameLayout"
        package="com.grability.rappi" content-desc=""
        clickable="false" enabled="true" bounds="[0,0][1080,2340]">
    <node index="0" text="Geant" resource-id="com.grability.rappi:id/storeName"
          class="android.widget.TextView" content-desc=""
          clickable="true" enabled="true" bounds="[54,1910][586,1969]">
    </node>
    <node index="1" text="" resource-id="com.grability.rappi:id/searchBar"
...
| `clickable` | Incluir si `clickable="true"` O si tiene `resource-id` de Rappi |
...
1. Use `resource-id` to differentiate:
   ...
   <webElementProperties>
      ...
      <value>com.grability.rappi:id/storeName</value>
   </webElementProperties>
   ```

2. Or ATTRIBUTES XPath combining text + resource-id:
   ```
   //*[@class='android.widget.TextView' and @text='Geant' and @resource-id='com.grability.rappi:id/storeName']
   ```
...
- Label: `resource-id="com.grability.rappi:id/storeName"` + `text="Geant"`
- Best locator: `resource-id=com.grability.rappi:id/storeName` + `text=Geant`
