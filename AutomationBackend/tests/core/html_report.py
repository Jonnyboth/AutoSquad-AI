...
.row__id { flex: 1 1 auto; font-family: "SFMono-Regular", Menlo, Consolas, monospace; font-size: 13px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
  ...
  function renderRows() {
    ...
    rowsEl.innerHTML = filtered.map(function (t) {
      ...
      return '<div class="row" style="background:' + c.bg + ";border-color:" + c.faint + ";border-left-color:" + c.border + '">' +
        ...
        '<span class="row__id">' + esc(t.testId) + "</span>" +
